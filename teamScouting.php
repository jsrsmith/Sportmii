...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='teamScoutingPopup.js'>
    </script>     
        
    <!--link to call jquery file to cancel editing positions-->
    <script
    src='teamCancelProfileScoutingPopup.js'>
    </script> 
...
echo <<<_END
 ...
 <form action="teamScouting.php" method="post" id="scoutForm">
...
<form action="teamScouting.php" method="post" id="unscoutForm">
...
print '<form action="teamScouting.php" id="profileScoutingForm" method="post">';
...
print '<form action="teamScouting.php" id="profileScoutedForm" method="post">';
