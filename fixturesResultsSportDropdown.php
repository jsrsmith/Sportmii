...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='fixturesResultsSportOnChange.js'>
    </script>
...
<div id=fixturesResultsSportDropdownTitle>
<p>select sport</p>
</div>

<select name="fixturesResultsSportDropdownList" id="fixturesResultsSportDropdownList">
