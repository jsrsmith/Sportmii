...
if(isset( $_SESSION['clubID'], $_POST['submitDefaultTeam']))
{
...
$insertDefaultTeam->execute([$defaultTeam, $clubID]); 
...
$defaultLeagueAlready->execute([$clubID]);
...
<div class=clubDefaultLeaguesSportDropdown>
</div>

<div class=clubDefaultLeaguesYearDropdown>
</div>

<div class=clubDefaultLeaguesDistrictDropdown>
</div>

<div class=clubDefaultLeaguesAgeDropdown>
</div>

<div class=clubDefaultLeaguesDivisionDropdown>
</div>    
...
//execute query with variables
$defaultTeamAlready->execute([$clubID]);
...
<div class=defaultTeamForLeagueTablePopup>
     ...
     <form action="clubLeagueTable.php" method="post" id="defaultTeamForLeagueTableForm">
