...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='fixturesResultsDistrictOnChange.js'>
    </script>
...
<div id=fixturesResultsDistrictDropdownTitle>
<p>select district</p>
</div>
...
print '<select name="fixturesResultsDistrictDropdownList" id="fixturesResultsDistrictDropdownList">';
