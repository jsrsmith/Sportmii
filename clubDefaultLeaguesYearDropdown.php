...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='clubDefaultLeaguesYearOnChange.js'>
    </script>
...
<div id=clubDefaultLeaguesYearDropdownTitle>
<p>select year</p>
</div>
...
print '<select name="clubDefaultLeaguesYearDropdownList" id="clubDefaultLeaguesYearDropdownList">';
