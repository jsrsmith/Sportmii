...
<html>
    ...
    <script
    src='clubTeamListPopup.js'>
    </script> 
       
    <!--link to call jquery file to cancel key buttons-->
    <script
    src='clubTeamListCancelPopup.js'>
    </script> 
...
<div id=clubTeamListPopup>
    
     <form action="clubTeamList.php" method="post" id="clubTeamListForm">

    <div id=clubAddTeamListTitle>
    <p>enter team ID to add team</p>
    </div>
    
    <input type="text" name="clubTeamListID" value="$newTeamID" id="clubTeamListID" />
      
    <div id=clubTeamListCheckTeamID>
    </div>
        
        
    <div id=clubTeamListPopupButtons>
    <div id=cancelClubTeamList>
     <button type="button" class="cancelClubTeamListButton">cancel</button>
    </div>
    <div id=submitClubTeamList>
     <input type="submit" name="submitAddTeamList" value="add team" id="submitAddTeamList" />
     </div>
    </div>        
