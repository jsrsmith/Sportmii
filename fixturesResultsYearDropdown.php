...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='fixturesResultsYearOnChange.js'>
    </script>
...
<div id=fixturesResultsYearDropdownTitle>
<p>select year</p>
</div>
...
print '<select name="fixturesResultsYearDropdownList" id="fixturesResultsYearDropdownList">';
