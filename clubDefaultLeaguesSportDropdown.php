...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='clubDefaultLeaguesSportOnChange.js'>
    </script>
...
<div id=clubDefaultLeaguesSportDropdownTitle>
<p>select sport</p>
</div>

<select name="clubDefaultLeaguesSportDropdownList" id="clubDefaultLeaguesSportDropdownList">
