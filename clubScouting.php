...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='clubScoutingPopup.js'>
    </script>     
        
    <!--link to call jquery file to cancel editing positions-->
    <script
    src='clubCancelProfileScoutingPopup.js'>
    </script> 
...
echo <<<_END
 ...
 <form action="clubScouting.php" method="post" id="scoutForm">
...
<form action="clubScouting.php" method="post" id="unscoutForm">
...
print '<form action="clubScouting.php" id="profileScoutingForm" method="post">';
...
print '<form action="clubScouting.php" id="profileScoutedForm" method="post">';
