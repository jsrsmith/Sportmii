...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='teamDefaultLeaguesDistrictOnChange.js'>
    </script>
...
<div id=teamDefaultLeaguesDistrictDropdownTitle>
<p>select district</p>
</div>
...
print '<select name="teamDefaultLeaguesDistrictDropdownList" id="teamDefaultLeaguesDistrictDropdownList">';
