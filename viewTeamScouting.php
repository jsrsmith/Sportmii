...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='viewTeamScoutingPopup.js'>
    </script>     
        
    <!--link to call jquery file to cancel editing positions-->
    <script
    src='viewTeamCancelProfileScoutingPopup.js'>
    </script> 
...
$scoutUser->execute([$teamID, $teamName, $username, $fullname]);
...
{          
        ...
        //execute query and variables
$unscoutUser->execute([$teamID, $username]);
...
//execute query with variables
$scoutingAlready->execute([$teamID, $username]);
...
echo <<<_END
 ...
 <form action="viewTeamScouting.php" method="post" id="scoutForm">
...
<form action="viewTeamScouting.php" method="post" id="unscoutForm">
...
print '<form action="viewTeamScouting.php" id="profileScoutingForm" method="post">';
...
print '<form action="viewTeamScouting.php" id="profileScoutedForm" method="post">';
