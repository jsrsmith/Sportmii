...
if(isset( $_SESSION['clubID']))
{
    ...
    //find club name
    $findClubNameFromClubID = $pdo->prepare('SELECT clubName FROM clubs WHERE id=?'); 

//execute query with variables
$findClubNameFromClubID->execute([$clubIDNoCode]);
    
 ($clubNameFromID = $findClubNameFromClubID->fetchcolumn());   
...
<p>$clubNameFromID have not setup a default league table yet</p>
</div>
...
<div class=profileLeagueExplanation>
<p>$clubNameFromID have not setup a default team yet</p>
</div>
