...
if(isset( $_SESSION['teamID']))
{
    ...
    //find team name
    $findTeamNameFromTeamID = $pdo->prepare('SELECT teamName FROM teams WHERE id=?'); 

//execute query with variables
$findTeamNameFromTeamID->execute([$teamID]);
    
 ($teamNameFromID = $findTeamNameFromTeamID->fetchcolumn());   
...
<p>$teamNameFromID have not setup a default league table yet</p>
</div>
