...
if (isset($_POST['continue']))
{
    ...
    if (isset($_POST['firstname'], $_POST['surname'], $_POST['gender']))
    {
    ...
    if 
        ...
        ($firstname == "" || $surname == "" || $gender == "default" || $dob == 0) 
...
_END;
    ...
    //if firstname or surname have too many characters
    else if 
        
        ((strlen($firstname) > 35) || (strlen($surname) > 35))
            {  
echo <<<_END
<div id=namestoolong>
<p>sorry! names can only take 35 characters.</p>
</div>
_END;
    ...
    $dob              = strtolower($dob);
                ...
                $_SESSION['surnamesignup'] = $surname;
                $_SESSION['gendersignup'] = $gender;
                $_SESSION['dobsignup'] = $dob;
  
echo <<<_END
<script>
  window.location.href = "continuesignup.php";
</script>
_END;
...
<!--sportmii logo next to heading-->
    ...
    <br>
        ...
        <p>gender
        <br>
        <input type="hidden" name="gender"  value="default" checked="checked" />
