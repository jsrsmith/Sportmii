...
<script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    ...
    <script
    src='feedDeleteShoutCommentAjax.js'>
    </script>
...
<form action="feedComments.php" id="commentOnPostForm$feedID" method="post">
...
<input type="submit" name="commentOnPost" class="commentOnPost" value="add">
...
$(document).ready(function()
{
 ...
 $('#commentOnPostForm<?php echo $feedID ?>').on('submit', function (e) {  
    e.preventDefault();
